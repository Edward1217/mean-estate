        ...
        <div className='p-7 border-b-2 md:border-r-2 md:min-h-screen'>
            <form onSubmit={handleSubmit} className='flex flex-col gap-8'>
                ...
                <div className='flex items-center gap-2'>
                    ...
                    <select  defaultValue={'created_at_desc'} onChange={handleChange} id = 'sort_order' className='border rounded-lg p-3'>
                ...
                <button className='text-white bg-slate-700 p-3 uppercase hover:opacity-95'>Search</button>
            </form>
        </div>
        <div className=''>
