    ...
    <main className ='p-3 max-w-4xl mx-auto'>
        ...
        <form className = 'flex flex-col sm:flex-row gap-4'>
            ...
            <div className= 'flex flex-col flex-1 gap-4' >
                ...
                <span className='text-gray-700 font-normal ml-2'>The first image will be the cover(Max 6)</span>
                <div className='flex gap-4'>
                    <input disabled={uploading} onChange={(e)=> setFiles(e.target.files)} type='file' className='p-3 border border-gray-300 rounded-lg w-full' accept='image/*' multiple/>
                    <button type='button' onClick = {handleImageSubmit} className='p-3 text-green-700 border border-green-700 rounded-lg uppercase hover:shadow-lg disabled:opacity-80' >{uploading ?'Uploading...':'Upload'}</button>
                </div>
                ...
                <button className='p-3 bg-slate-700 text-white rounded-lg uppercase hover:opacity-95 disabled:opacity-80' disabled={uploading}>Create listing'</button>   
            </div> 
        </form>
    </main>
  )
